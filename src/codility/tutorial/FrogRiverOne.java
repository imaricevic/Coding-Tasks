 ...
 *         find the earliest moment when all the positions from 1 to X are
 *         covered by leaves). You may assume that the speed of the current in
 *         the river is negligibly small, i.e. the leaves do not change their
 *         positions once they fall in the river.
 * 
 *         For example, you are given integer X = 5 and array A such that:
 * 
 *         A[0] = 1 A[1] = 3 A[2] = 1 A[3] = 4 A[4] = 2 A[5] = 3 A[6] = 5 A[7] =
 *         4 In second 6, a leaf falls into position 5. This is the earliest
 ...
 * 
 *         that, given a non-empty array A consisting of N integers and integer
 ...
 * 
 *         A[0] = 1 A[1] = 3 A[2] = 1 A[3] = 4 A[4] = 2 A[5] = 3 A[6] = 5 A[7] =
 *         4 the function should return 6, as explained above.
 * 
 *         Write an efficient algorithm for the following assumptions:
 * 
 *         N and X are integers within the range [1..100,000]; each element of
 *         array A is an integer within the range [1..X]. Copyright 2009–2020 by
