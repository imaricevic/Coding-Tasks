 ...
 * @author imaricevic
 *
 *         A non-empty array A consisting of N integers is given. The
 ...
 *         For example, given:
 * 
 *         A[0] = 0 A[1] = 1 A[2] = 0 A[3] = 1 A[4] = 1 the function should
 *         return 5, as explained above.
 * 
 *         Write an efficient algorithm for the following assumptions:
 * 
 *         N is an integer within the range [1..100,000]; each element of array
 *         A is an integer that can have one of the following values: 0, 1.
 * 
