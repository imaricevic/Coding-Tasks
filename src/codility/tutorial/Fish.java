 ...
 *         < Q, then fish P is initially upstream of fish Q. Initially, each
 *         fish has a unique position.
 * 
 ...
 * 
 *         A[0] = 4 B[0] = 0 A[1] = 3 B[1] = 1 A[2] = 2 B[2] = 0 A[3] = 1 B[3] =
 *         0 A[4] = 5 B[4] = 0 Initially all the fish are alive and all except
 *         fish number 1 are moving upstream. Fish number 1 meets fish number 2
 *         and eats it, then it meets fish number 3 and eats it too. Finally, it
 ...
 *         A is an integer within the range [0..1,000,000,000]; each element of
 *         array B is an integer that can have one of the following values: 0,
