 ...
 *         = 10 (2, 4, 5), product is 2 * 5 * 6 = 60 Your goal is to find the
 ...
 * 
 *         A[0] = -3 A[1] = 1 A[2] = 2 A[3] = -2 A[4] = 5 A[5] = 6 the function
 *         should return 60, as the product of triplet (2, 4, 5) is maximal.
 * 
...
public class MaxProductOfThree {
	...
	public int solution(int[] A) {
		...
		if(A[0] < 0 && A[1] < 0 && A[A.length - 1] > 0) {
			return Math.max(A[0] * A[1], A[A.length - 2] * A[A.length - 3]) * A[A.length - 1];
		}
		else {
