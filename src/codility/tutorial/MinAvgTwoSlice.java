 ...
 *         by the length of the slice. To be precise, the average equals (A[P] +
 *         A[P + 1] + ... + A[Q]) / (Q − P + 1).
 * 
 ...
 * 
 *         slice (1, 2), whose average is (2 + 2) / 2 = 2; slice (3, 4), whose
 *         average is (5 + 1) / 2 = 3; slice (1, 4), whose average is (2 + 2 + 5
 *         + 1) / 4 = 2.5. The goal is to find the starting position of a slice
 *         whose average is minimal.
 * 
 *         Write a function:
 * 
 ...
 * 
 *         A[0] = 4 A[1] = 2 A[2] = 2 A[3] = 5 A[4] = 1 A[5] = 5 A[6] = 8 the
